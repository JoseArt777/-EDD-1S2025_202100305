...
uses
  GTK2, GDK2, SysUtils, Classes, DataStructures, SystemCore;
...
begin
  ...
  begin
    ...
    gtk_window_set_modal(GTK_WINDOW(FWindow), True);
  end;
end;

procedure TBaseWindow.ConnectSignals;
begin
  // Señales básicas se pueden agregar aquí si es necesario
end;
...
class function TUIUtils.CreateButton(Text: String; Callback: Pointer; Data: gpointer): PGtkWidget;
begin
